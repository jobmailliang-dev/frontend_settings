...
import type { ToolConfig, ToolParameter } from '@next/types/tool';
import { useToolStore } from '@next/stores/toolStore';
import MonacoEditor from '@next/components/MonacoEditor/MonacoEditor.vue';
import ToolParamForm from '@next/components/ToolParamForm.vue';
import ToolDebugPanel from '@next/components/ToolDebugPanel.vue';
import Console from '@next/components/MonacoEditor/Console.vue';
