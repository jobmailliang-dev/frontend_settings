...
import type { ToolConfig, ToolParameter } from '@settings/types/tool';
import { useToolStore } from '@settings/stores/toolStore';
import MonacoEditor from '@settings/components/MonacoEditor/MonacoEditor.vue';
import ToolParamForm from '@settings/components/ToolParamForm.vue';
import ToolDebugPanel from '@settings/components/ToolDebugPanel.vue';
import Console from '@settings/components/MonacoEditor/Console.vue';
